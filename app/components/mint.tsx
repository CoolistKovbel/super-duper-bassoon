...
const MintComponent = () => {
  ...
  return (
    <section className="w-full flex-col flex gap-4">
      ...
      <header>
        <h2 className="text-4xl md:text-2xl font-bold mb-2">Ektoro Park Collection</h2>
        <p className="text-sm">
      ...
      <div className="flex flex-col items-start gap-4 bg-[#222] p-3">
        <p className="p-2 bg-[#111] w-full flex justify-between rounded-lg p-2 text-center align-center">Address: <span className="text-sm">0xe68C0fdcD264BE35BfBEb5067a7062Fc912e747</span></p> 
